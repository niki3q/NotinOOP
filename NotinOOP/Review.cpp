...
Review::Review(int userId, const std::string& fragranceName, double rating, const std::string& comment)
	: reviewId(nextId++), userId(userId), fragranceName(fragranceName), comment(comment), rating(rating)
{
...
Review::Review(int id, int userId, const std::string& fragranceName, double rating, const std::string& comment)
